...
def main():
    ...
    # =========================================================================
    # Fixed Assets, K100701
    # =========================================================================
    cap_a_a = _df.loc[:, ['K100701']].mul(_defl)
    # =========================================================================
    ...
    prd_a_b = _df.loc[:, ['A032RC1']].div(
        _df.loc[:, ['CAPUTL.B50001.A']]).mul(_defl).mul(100)
    prd_b_a = _df.loc[:, ['A191RC1']].mul(_df.loc[:, ['A191RD3']])
    prd_b_b = _df.loc[:, ['A191RX1']]
    # =========================================================================
    # Option 1: 1967--2012
    # =========================================================================
    pd.concat([_df.loc[:, ('K100701',)].mul(_defl), L, prd_a_a], axis=1
                   ).pipe(transform_add_dx_dy)
    # =========================================================================
    # Option 2: 1967--2012
    # =========================================================================
    pd.concat([_df.loc[:, ('K100701',)].mul(_defl), L, prd_a_b], axis=1
                   ).pipe(transform_add_dx_dy)
    # =========================================================================
    # Option 3: 1967--2012
    # =========================================================================
    pd.concat([cap_a_b, L, prd_a_a], axis=1).pipe(transform_add_dx_dy)
    # =========================================================================
    # Option 4: 1967--2012
    # =========================================================================
    pd.concat([cap_a_b, L, prd_a_b], axis=1).pipe(transform_add_dx_dy)
    # =========================================================================
    ...
    # Option 1: 1929--2013
    # =========================================================================
    pd.concat([cap_b_a, L, prd_b_a], axis=1).pipe(transform_add_dx_dy)
    # =========================================================================
    # Option 2: 1929--2013
    # =========================================================================
    pd.concat([cap_b_b, L, prd_b_b], axis=1).pipe(transform_add_dx_dy)
    # =========================================================================
    # Option 5: 1929--2013
    # =========================================================================
    pd.concat([cap_b_c, L, prd_b_a], axis=1).pipe(transform_add_dx_dy)
