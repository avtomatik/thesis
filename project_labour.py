...
def prices_cobb_douglas():
    data = pd.read_csv('dataset-usa-cobb-douglas.zip')
...
def prices_census():
    data = pd.read_csv('dataset-usa-census1975.zip')
    vectors = ('P0107',  'P0110')
    combined = pd.Data_frame()
    for vector in vectors:
...
# # combined.to_excel('C:\\Projects\\result.xlsx')
...
# # data = combined
# data = pd.read_excel('stat_can_cap.xlsx')
# data.set_index(data.columns[0],  inplace=True)
# from itertools import combinations
# from sklearn.metrics import r2_score
# result = pd.Data_frame(columns = ['vector1',  'vector2',  'r2'])
...
# data = pd.read_excel('C:\\Users\\Mastermind\\Downloads\\stat_can_cap_matching.xlsx')
...
# data.to_excel('C:\\Users\\Mastermind\\Downloads\\stat_can_cap_matching_alpha.xlsx',  index = True)
