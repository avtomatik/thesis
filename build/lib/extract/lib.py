...
def extract_can_quarter(data_frame, series_id) -> DataFrame:
    '''
...
def extract_can_quarter(file_id, series_id) -> DataFrame:
    '''
    Data Frame Fetching from Quarterly Data within CANSIM Zip Archives
...
def extract_usa_bea_filter(series_id) -> DataFrame:
    '''
...
def extract_usa_bea_from_loaded(data_frame: DataFrame, series_id: str) -> DataFrame:
...
def extract_world_bank(data_frame: DataFrame, series_id: str) -> DataFrame:
